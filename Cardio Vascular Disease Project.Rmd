...
We choose several factors from the dataset and check if there are some factors that have a significant difference between CVD presented and CVD not presented.
